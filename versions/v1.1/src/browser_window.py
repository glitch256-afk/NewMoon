...
class PaleMoonChromiumBrowser(QMainWindow):
    def __init__(self, is_far_side=False):
        ...
        # Window Title updates depending on Far Side mode
        title_suffix = " (Far Side)" if self.is_far_side else ""
        self.setWindowTitle(f"NewMoon Browser{title_suffix}")
        ...
        # Colors & Theme (Far Side uses a darker stealth profile)
        ...
        # Set up Off-The-Record Profile for Far Side mode
        if self.is_far_side:
    ...
    def open_far_side_window(self):
        """Launches an isolated private window"""
    ...
    def add_new_tab(self, qurl=None, label="New Tab"):
        ...
        # Attach web view to either the default or Far Side off-the-record profile
    ...
    def create_menu_bar(self):
        ...
        # Added Far Side Mode Menu Option
        far_side_action = QAction("🌑 New Far Side Window", self)
        far_side_action.setShortcut(QKeySequence("Ctrl+Shift+N" if sys.platform != "darwin" else "Cmd+Shift+N"))
